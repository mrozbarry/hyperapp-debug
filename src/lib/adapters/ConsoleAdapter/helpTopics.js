...
export const helpTopics = [
  ...
  ...makeHelpTopic({
    ...
    ...makeHelpTopic({
      ...
      ...makeHelpTopic({
        topic: '<adapter>.resumeFromHere',
        summary: 'function, resume the app from the current state',
        data: [
          'This allows you to resume the app at the current point in history your have time-travelled to',
          'This will rewrite history, and you will lose your previous future history',
          'Usage 1: <adapter>.resumeFromHere()',
        ],
      }),
    ]),
    ...makeHelpTopic({
